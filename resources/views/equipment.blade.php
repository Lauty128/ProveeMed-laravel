...
<section class="Information">
    ...
    <div class="Information__header">
        <div class="Information__image">
            <img src="{{ $equipment->image ?? asset('/img/not-found.png') }}" alt="">
        </div>
        <div>
    ...
    <section class="Information__section">
        ...
        <article class="Information__listSection">
            ...
            <div id="List" class="Information__listContainer" data-url="{{ route('providers-of-equipment', ['id' => $equipment->id]) }}" data-redirect="{{ route('providers') }}">
