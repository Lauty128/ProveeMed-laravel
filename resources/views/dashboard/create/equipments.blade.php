<x-app-layout>
  ...
  <div class="py-9 max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white shadow rounded-lg p-6">
          ...
          <form method="POST" id="CreateForm" action="{{ route('dashboard.equipments.create') }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2">
                  <div>
                      <label for="" class="text-gray-600">Umdns <a href="#">Descargar lista</a></label>
                      <input type="text" name="umdns" class="border p-2 rounded w-full" placeholder="00-000" value="{{ old("umdns") }}">
                  ...
                  <div>
                      ...
                      <div class="relative rounded shadow-sm">
                        ...
                        <input type="text" name="price" id="price" class="block w-full rounded border-0 p-2 pl-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6" placeholder="0.00">
                      </div>
